...
/***/ (function(module, exports, __webpack_require__) {
	...
	//	// sunucudan gelen arama önerilerini ayrýþtýrýr ve bir dizi olarak döndürür.
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function init(view, config) {
		view.structure = {
			...
			"up": up.init(view),
			"path": path.init(view),
			"search": search.init(view),//kullanýcýnýn arama yaptýðý anda tetiklenir ve arama sonuçlarýný alýr. Sonuçlarý bir tablo olarak gösterir ve seçilen dosyayý açar.
