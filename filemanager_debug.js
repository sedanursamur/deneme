...
/***/ (function (module, exports, __webpack_require__) {
    ...
    function loadSearchData(view, url, id, value) {
        debugger;
            ...
            if (view.callEvent("onBeforeSearchRequest", [id, params])) {
                webix.ajax().post(url, params, function (text, data, xhr) {
                    var response = JSON.parse(text);
                    parseSearchData(view, response);
                    view.$searchValue = value;
                }, function (xhr) {
        ...
        function parseSearchData(view, data) {
            ...
            var cell = view.$$(view.config.mode);
            if (cell && cell.filter) {
                var suggestData = data.map(function (item) {
                    return item.name;
                });
                view.$$("search").define("suggest", { data: suggestData });
                view.$$("search").refresh();
            }
        }
                ...
                "search": {
                    ...
                    on: {
                        ...
                        onTimedKeyPress: function () {
                            debugger;
                            var value = view.$$("search").getValue();
                            if (value.length >= 3) {
                                var params = { action: "search", source: "", text: value };
                                loadSearchData(view, "", "", value);
                            }
                        },
                        onChange: function () {
                            var value = view.$$("search").getValue();
...
/***/ (function (module, exports) {
        ...
        function init(view) {
            ...
            return {
                view: "button", type: "htmlbutton", css: "webix_fmanager_back",
...
/***/ (function (module, exports) {
        ...
        function init(view) {
            ...
            return {
                view: "button", type: "htmlbutton", css: "webix_fmanager_collapse",
...
/***/ (function (module, exports) {
        ...
        function init(view) {
            ...
            return [{
                id: "value", header: locale.name, fillspace: 3, sort: "string", template: function template(obj, common) {
                    var name = common.templateName(obj, common);
                    return common.templateIcon(obj, common) + name;
                }, editor: "text"
            }, {
                id: "date", header: locale.date, fillspace: 2, sort: "int", template: function template(obj, common) {
...
/***/ (function (module, exports) {
        ...
        function init(view) {
            ...
            return {
                view: "button", type: "htmlbutton", css: "webix_fmanager_expand",
...
/***/ (function (module, exports) {
        ...
        function init(view) {
            ...
            return {
                view: "button", type: "htmlbutton", css: "webix_fmanager_forward",
                label: "<div class=\"webix_fmanager_bar_icon \"></div>", width: 37,
...
/***/ (function (module, exports) {
        ...
        function init(view) {
            ...
            return {
                view: "button", type: "htmlbutton", label: "<div class=\"webix_fmanager_bar_icon \"></div>",
...
/***/ (function (module, exports) {
        ...
        function init(view, settings) {
            ...
            var config = {
                view: "segmented", width: 70, options: [{
                    id: "files",
                    width: 32,
...
/***/ (function (module, exports) {
        ...
        function init(view) {
            ...
            return { view: "search", gravity: 0.3, minWidth: 300, css: "webix_fmanager_search", icon: " webix_fmanager_icon" };
        }
...
/***/ (function (module, exports) {
        ...
        function init(view) {
            ...
            return {
                view: "button", type: "htmlbutton", css: "webix_fmanager_toggle",
                label: "<div class=\"webix_fmanager_bar_icon \"></div>", width: 30,
...
/***/ (function (module, exports) {
        ...
        function init(view) {
            ...
            return {
                view: "button", type: "htmlbutton", css: "webix_fmanager_up",
                label: "<div class=\"webix_fmanager_bar_icon \"></div>", width: 37,
